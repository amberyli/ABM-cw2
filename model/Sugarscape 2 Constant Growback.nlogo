...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "set-plot-x-range 0 (max [vision] of turtles + 1)\nset-plot-pen-interval (max [vision] of turtles + 1) / 10\nhistogram [vision] of turtles"
...
"" ""
PENS
"default" 1.0 1 -16777216 true "" "set-histogram-num-bars 5\nset-plot-x-range 0 (max [metabolism] of turtles + 1)\nset-plot-pen-interval (max [metabolism] of turtles + 1) / 10\nhistogram [metabolism] of turtles"
...
@#$#@#$#@
<experiments>
  <experiment name="experiment on model 2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="ip=50" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>survival-rate</metric>
  ...
  <experiment name="ip=400" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>survival-rate</metric>
  ...
  <experiment name="ip=1000" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>survival-rate</metric>
